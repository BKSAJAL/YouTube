...
function NotFound() {
  ...
  return (
    // 404 page not found
    <div className="flex flex-col gap-6 justify-center items-center text-black h-[600px] backdrop-blur-xl">
      ...
      <button
        ...
        className="mt-4 px-4 py-2 text-lg bg-black/40 text-white rounded-lg hover:bg-black/50"
      >
        🏠 Home Page
      </button>
    </div>
